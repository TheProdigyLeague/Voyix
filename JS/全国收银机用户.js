!usr/bin/ncr-retail-demo/etc/pwd/profile~$
/** 
                 __   _          __                _    __               
 _   _ ___ _ __ / /__| |_ ___   / / ____      ____| |  / / __  _ __ ___  
| | | / __| '__/ / _ \ __/ __| / / '_ \ \ /\ / / _` | / / '_ \| '__/ _ \ 
| |_| \__ \ | / /  __/ || (__ / /| |_) \ V  V / (_| |/ /| |_) | | | (_) |
 \__,_|___/_|/_/ \___|\__\___/_/ | .__/ \_/\_/ \__,_/_/ | .__/|_|  \___/ 
                                 |_|                    |_|              
**/

import React, { useState } from 'react';$

import { Row, Card, CardBody, CardTitle, Col, Alert, ListGroup } from 'reactstrap';$
              ...
              <Col>$
                <div className="form-group float-right">$
                  <Button color="primary" type="submit" className={`${!(dirty && isValid) ? 'disabled' : ''}`} disabled={!(dirty && isValid)}>$
                    {isUpdating ? <Spinner color="light" size="sm" /> : <span>👺🍩  ^Đ ρŕ๏𝕗ίĹ𝒆 :Đ  ♟♜</span>}$
                  </Button>$
                </div>$
              </Col>$
              $
...
export default function Sidebar({ url }) {$
  return ($
    <ListGroup>$
      <a href="/user/profile" className={`list-group-item ${url === 'profile' && 'active'}`}>$
        Profile$
      </a>$
      <a href="/user/orders" className={`list-group-item ${url === 'orders' && 'active'}`}>$
        Orders$
      </a>$
